...
// Before DNS is verified, Resend requires sending from onboarding@resend.dev.
// After you verify bridgn.app in Resend, change this to notifications@bridgn.app
const FROM_EMAIL = process.env.EMAIL_FROM || "bridgn <onboarding@resend.dev>";
...
const footer = `
  <div style="margin-top:32px;padding-top:16px;border-top:1px solid #e5e7eb;font-size:12px;color:#9ca3af;">
    <a href="https://bridgn.app" style="color:#5b8af5;text-decoration:none;font-weight:600;">bridgn</a> — The creator-brand partnership platform
  </div>
`;
...
function paymentSettledEmail({ brandName, creatorName, amount, dealTitle }) {
  return {
    ...
    html: wrap(`
      ...
      <a href="https://bridgn.app" style="display:inline-block;padding:10px 24px;background:#5b8af5;color:white;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;">
        Open Deal Room
      </a>
    `),
  };
