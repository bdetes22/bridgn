...
router.put("/mark-live", async (req, res) => {
  ...
  try {
    ...
    // Note: We do NOT auto-release escrow on LIVE. The brand controls when to
    // release the upfront payment. Mark-as-LIVE just updates the status and
    // notifies the brand that content is live and they can release when ready.
